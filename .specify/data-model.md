...
interface Todo {
  ...
  tags?: string[];               // Phase V: user-defined labels
  recurrenceRule?: RecurrenceRule | null;  // Phase V: 'daily' | 'weekly' | 'monthly'
  reminderMinutesBefore?: number | null;  // Phase V: minutes before due
...
interface FilterState {
  ...
  tagFilter: string;             // Phase V: '' = all, else filter by tag
}
