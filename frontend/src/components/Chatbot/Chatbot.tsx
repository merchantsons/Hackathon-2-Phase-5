...
export const Chatbot: React.FC = () => {
  ...
  // Quick commands: 4 new create todos with matching complete and delete for each
  const commandExamples = [
    { category: 'Create Todos', commands: [
      'Create a todo called Plan team meeting for next Monday',
      'Create a todo called Send weekly report to manager',
      'Create a high priority todo called Update project documentation',
      'Create a todo called Review and approve budget proposal'
    ]},
    { category: 'Complete Todos', commands: [
      'Complete the todo Plan team meeting',
      'Complete the todo Send weekly report',
      'Complete the todo Update project documentation',
      'Complete the todo Review and approve budget proposal'
    ]},
    { category: 'Delete Todos', commands: [
      'Delete the todo Plan team meeting',
      'Delete the todo Send weekly report',
      'Delete the todo Update project documentation',
      'Delete the todo Review and approve budget proposal'
    ]},
