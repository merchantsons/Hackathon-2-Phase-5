        ...
        inputSchema: {
          ...
          properties: {
            ...
            reminder_minutes_before: {
              type: 'number',
              description: 'Optional minutes before due_date to remind',
            },
          },
          required: ['title'],
        },
        ...
        inputSchema: {
          ...
          properties: {
            ...
            tags: {
              type: 'array',
              items: { type: 'string' },
              description: 'New list of tag labels',
            },
            recurrence_rule: {
              type: 'string',
              enum: ['daily', 'weekly', 'monthly'],
              description: 'Recurrence: daily, weekly, or monthly (empty to clear)',
            },
            reminder_minutes_before: {
              type: 'number',
              description: 'Minutes before due_date to remind',
            },
          },
          required: ['task_id'],
        },
        ...
        switch (name) {
          ...
          case 'create_task': {
            const newTask = await apiClient.createTask({
              ...
              recurrence_rule: args.recurrence_rule as 'daily' | 'weekly' | 'monthly' | undefined,
              reminder_minutes_before: args.reminder_minutes_before as number | undefined,
            });
            return {
              content: [
                {
